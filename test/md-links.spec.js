...
describe('fn obtenerRutaAbsoluta', () => {
  it('deberia devolver ruta absoluta cuando se le pasa una ruta relativa', () => {
...
describe('fn esDirectorio', () => {
  it('deberia devolver true si la ruta es directorio', () => {
    const rutaDirectorio = './test';
    expect(esDirectorio(rutaDirectorio)).toBe(true);
  });
  it('deberia devolver false si la ruta no es directorio', () => {
...
describe('fn esArchivoMd', () => {
  ...
  it('deberia devolver false si la ruta no es un archivo md', () => {
...
describe('fn encontrarArchivoMdEnDirectorio', () => {
  it('deberia devolver una lista de rutas de archivos .md en un directorio', () => {
...
describe('fn validarLink', () => {
  it('deberia devolver una lista de links encontrados en un archivo md', () => {
...
// fn validarLink::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
describe('fn validarLink', () => {
  it('deberia devolver OK con codigo 200 si el link es valido', () => {
  ...
  it('deberia devolver FAIL con codigo 404 si el link es invalido', () => {
...
describe('fn estadisticas', () => {
  it('deberia devolver el recuento total de links', () => {
    const links = [
